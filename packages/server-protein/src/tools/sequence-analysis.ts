...
export const sequenceAnalysis = defineTool({
  ...
  schema: z.object({
    sequence: z.string().min(1).describe("The amino acid or nucleotide sequence"),
    seq_type: z.enum(["protein", "DNA", "RNA"]).optional().describe("Sequence type (default: protein)"),
    translate: z.boolean().optional().describe("If DNA/RNA, translate to protein (default: false)"),
  }),
